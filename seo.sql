...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2013 at 11:33 AM
...
-- Database: `seo`
--
CREATE DATABASE IF NOT EXISTS `seo` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `seo`;
...
CREATE TABLE IF NOT EXISTS `tags` (
  ...
  `stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=97645 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=396489 ;
